...
<div class="text-center">
  <a href="pages/forms/AddationOrder.php" class="btn btn-default btn-rounded mb-4"   style="background-color:rgba(191, 131, 36, 1);
    color: #ededf5;
    width:100%;
...
<div class="text-center">
  <a href="pages/forms/TransferOrder.php" class="btn btn-default btn-rounded mb-4"  style="background-color:rgba(191, 131, 36, 1);
    color: #ededf5;
    width:100%;
    border-top-color: #eee;">عرض
    </a>
...
<div class="text-center">
  <a href="pages/forms/GivingOrder.php" class="btn btn-default btn-rounded mb-4" style="background-color: rgba(191, 131, 36, 1);
    color: #ededf5;
    width:100%;
    border-top-color: #eee;">عرض
    </a>
