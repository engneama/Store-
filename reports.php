            ...
            <div class="icon">
              <i class="ion ion-pie-graph"></i>
				...
				<div class="text-center">
				  <a href="pages/forms/ItemReport.php" class="btn btn-default btn-rounded mb-4"   style="background-color: rgb(191, 36, 36);
					color: #ededf5;
					width:100%;
          ...
          <div class="small-box bg-red">
            ...
            <div class="icon">
              <i class="ion ion-pie-graph"></i>
						...
						<div class="text-center">
						  <a href="pages/forms/StoreReport.php" class="btn btn-default btn-rounded mb-4"  style="background-color: rgb(191, 36, 36);
							color: #ededf5;
							width:100%;
							border-top-color: #eee;">عرض
							</a>
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p><strong>تقرير مستند</strong></p>
            </div>
            <div class="icon">
              <i class="ion ion-pie-graph"></i>
            </div>
					<div class="text-center">
					  <a href="pages/forms/ContractReport.php" class="btn btn-default btn-rounded mb-4"   style="background-color:  rgb(191, 36, 36);
						color: #ededf5;
						width:100%;
						border-top-color: #eee;">عرض
						</a>
